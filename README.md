...
[![MageCheck Status](https://img.shields.io/github/actions/workflow/status/graycoreio/magento2-daffodil/check-extension.yaml?&label=MageCheck&labelColor=1a1a1a)](https://github.com/graycoreio/magento2-daffodil/actions/workflows/check-extension.yaml)
